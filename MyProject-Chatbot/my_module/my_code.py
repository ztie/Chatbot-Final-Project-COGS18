...
class MentalDisorders():
    ...
    #Initialize instances of mental disorders with names of the disorders, passing in #informations for all 6 attributes. 
...
def disorder_filter(msg, DISORDERS, CATEGORIES):
    ...
    #Initialize a list of disorders that are going to be used in functions #"find_disorder()" and "find_ouput()"    
...
def find_disorder(disorders,name):
    ...
    """
    a function that takes in the name of the disorder to find the disorder instance with its corresponding name. 
    ...
    for disorder in disorders:
        ...
        if name == disorder.name:
            ...
            #the specific disorder instance is returned
            return disorder
...
def find_output(disorders,found):
    ...
    """
    a function that takes in the name and the aspect of the disorder to return the corresponding information retrived from the disorder instance. 
    ...
    Returns
    -------
    The corresponding attribute from the disorder instance.
